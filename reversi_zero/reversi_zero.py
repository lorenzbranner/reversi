...
class AlphaZero:
    ...
    def learn(
        ...
        for iteration in range(checkpoint_start + 1, self.num_iterations + 1):
            ...
            log("SelfPlay", f"Completed {self.num_selfPlay_iterations if not self.use_parralel_self_play else self.num_selfPlay_iterations * self.num_parallel_games} games in {duration:.2f}s")
